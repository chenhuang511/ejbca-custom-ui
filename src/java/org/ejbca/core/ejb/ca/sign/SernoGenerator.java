 ...
 *
 * @version $Id: SernoGenerator.java 11595 2011-03-23 12:24:28Z jeklund $
 */
...
//	private BigInteger highest = new BigInteger("7FFFFFFFFFFFFFFF", 16);
	...
	private BigInteger lowest = new BigInteger("00800000000000000000000000000000", 16);
	private BigInteger highest = new BigInteger("7FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF", 16);
	...
	public synchronized BigInteger getSerno() {
		...
		while (!ok) {
			...
			// Must be within the range 00800000000000000000000000000000 - 7FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
...
//		return serno;
	...
	public void setSernoOctetSize(final int noOctets) {
		if (this.noOctets != noOctets) {
			log.debug("noOctets: "+noOctets);
			////////////////////////////////////////
			// edit by Long.nguyen2 date: 09/05/2012
			// insert proccessing for lowest and highest with 4, 8, 16 octet
			if (noOctets == 4) {
			...
			if ((noOctets != 4) && (noOctets != 8) && (noOctets != 16) && (noOctets != 0)) {
				throw new IllegalArgumentException(
						"SernoOctetSize must be 4 or 8 or 16 for this generator.");
			}
			/////////////////////////////////////////
