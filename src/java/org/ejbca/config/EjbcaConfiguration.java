 ...
 * 
 * @version $Id: EjbcaConfiguration.java 17189 2013-06-18 11:41:51Z primelars $
 */
...
//        return Integer.parseInt(value);
        ...
        String value = ConfigurationHolder.getString("ca.serialnumberoctetsize", "16");
        if (!"16".equals(value) && !"8".equals(value) && !"4".equals(value)) {
            value = "16";
        }
        return Integer.parseInt(value);
...
//        return value * 1000L;
        ...
        try {
            //value = Long.parseLong(ConfigurationHolder.getString("approval.defaultrequestvalidity", String.valueOf(value)));
        	value = 259200L;//PhucTT Edit 2011_12_10
        } catch (NumberFormatException e) {
            log.warn("\"approval.defaultrequestvalidity\" is not a decimal number. Using default value: " + value);
        }
        return value * 1000L;
...
//        return value * 1000L;
    ...
    public static long getCachePublisherTime() {
        long time = 1000; // cache 1 second is the default
        try {
            time = Long.valueOf(ConfigurationHolder.getString("publisher.cachetime", "1000"));
        } catch (NumberFormatException e) {
            log.error("Invalid value in publisher.cachetime, must be decimal number (milliseconds to cache Publlisher): "
                    + e.getMessage());
        }
        return time;
    }
