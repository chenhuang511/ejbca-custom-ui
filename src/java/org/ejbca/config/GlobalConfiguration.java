 ...
 *
 * @version $Id: GlobalConfiguration.java 15376 2012-08-20 10:21:24Z samuellb $
 */
...
//    	String a = (String) data.get(GlobalConfiguration.PRIVATEPROTOCOL) + "://";
//    	String b = requestServerName  + "/";
//    	String c = (String) "annd" + "/";
//    	return a + b + c;
...
//    	String a = (String) data.get(GlobalConfiguration.PRIVATEPROTOCOL) + "://";
//    	String b = WebConfiguration.getHostName() + ":";//"localhost"  + ":";
//    	String c = (String) data.get(GlobalConfiguration.PRIVATEPORT) + "/"; //"8443"  + "/";
//    	String d = (String) "annd" + "/";
//    	return a + b + c + d;
    	return (String) data.get(GlobalConfiguration.PRIVATEPROTOCOL) + "://" + 
